    ...
    for i, vuln in enumerate(vulnerabilities):
        try:
            ...
            try:
                ...
                newData['v4']['sev'] = metrics.get("cvssMetricV4", [])[0].get("baseSeverity") or cvss_v4.get("baseSeverity")
            ...
            try:
                ...
                if cvss_v3_1:
                    ...
                    newData['v3']['sev'] = cvss_v3_1[0].get("baseSeverity") or cvss_v3.get("baseSeverity")
                    ...
                    if cvss_v3_0:
                        ...
                        newData['v3']['score'] = cvss_v3["baseScore"]
                        newData['v3']['sev'] = cvss_v3_0[0].get("baseSeverity") or cvss_v3.get("baseSeverity")
            ...
            try:
                ...
                if cvss_v2:
                    ...
                    newData['v2']['sev'] = cvss_v2[0].get("baseSeverity") or cvss_v2_data.get("baseSeverity")
